...
>“I have a lot of really good relationships with the founders of nonprofits and a bunch of celebrities. I would always use those relationships to help them because that's one of the things that definitely helps with festivals, bringing in more established name people.”
>
> #### Shay, Q 1.2
...
>“We do it primarily for the advertising stance on it. so that we could go to vendors next year and say “hey we have a growing festival 3500 people you should come you’ll make a shit load of money” but to me that’s not really really exciting but yeah that's why we do it for social media vendor stuff.”
>
> #### Darcy Q10.1.1
...
>“I don't believe in social media stuff so I don't have any of that shit but so... I'm always pushing for in person meetings. I feel like when we need to have an in-person meeting for 2 or 3 hours it saves dozens of hours of texts and Facebooks and e-mails and confusion...For me it's just e-mail and in-person. Because that’s all I got.“ (Darcy, Q4.6)

>“you can get five times more things done in an e-mail exchange than in about a quarter of the time, than you can in a phone conversation.”
>
> #### Kriska, Q4.6
...
>“I think instinctively, vegan people generally like to feel like everybody is bought in and everyone has the same equal value in their opinion. They feel their opinion isn't valued as much when everything isn't voted on. When I talk to them individually I try to sell to them the understanding that it slows the process. Like I said, if you want to be involved with what I used to be involved with, puts you on a hundred emails a day...People that like working together would see it as a weakness, and they would feel that their input is not bought in. My argument is always back, ‘well if you want input on absolutely on every aspect of this then you can be a part of that, and then you're a board member.’”
>
> #### Shay Q6.3.3

>“I learned to set timelines, better timelines, with artists creating stuff for shirts and for our flyer. And say I need it by this time as opposed to being like “have fun with it”, really laid-back. I’ll say get back to me in two weeks. and then when they have a deadline it comes back quicker than it would if I just said “hey”... I pay people now, the first year I didn’t pay people. but with volunteers I really can’t. They're volunteers. That way I also have the attitude that it's not going to go right, things will get messed up it's not going to be perfect. It's impossible.”
>
> #### Grey, Q6.3

We posed the following question to the interview participants: “If you were to suddenly have an unlimited number of volunteers, what would you first plan to do to ensure that your event was an annual success?” The responses we received suggests that volunteer labor would be used for outreach, specifically leafleting or emailing potential attendees. This illuminated a facet of VegFest organizing that helps make the event a success: outreach. Outreach is important but does not require a special skill or a sustained commitment to the group. We understand this to mean that VegFests have a point where publicity transforms from an essential task to a welcome service. The question that we posed implied that the imagined volunteers were valuable on account of their quantity, so it is understandable that interview participants envisioned tasks that are inexhaustible.

The counterpoint to this response was, as mentioned by three respondents, that the volunteers would be put to work on a task that they were well suited to do, presumably taking more than their quantity into account. This communicated that the number of volunteers is not always lacking, but the ability to match the volunteer with an appropriate duty might be. There is a line between where volunteers are a helpful resource and when they drain significant amounts of energy for coordination. The challenge of knowing where to draw this line usually falls to a volunteer coordinator. As one organizer noted, more volunteers require more coordination and more resources to make sure they are fed and taken care of. Because of this, having volunteers who are excited to do flyering, greeting people at the entrance, making phone calls or sales is important always, while concurrently making space for others who are not suited to these tasks participate in another way. *Briar* shared an important lesson she learned about compatibility that speaks to this issue (emphasis ours):

>“One thing I learned is **to make sure that just because I have volunteers, to make sure they all fit the roles, not decide the day of.** We're going to vet the volunteers this year. Here you just signed up to one role doesn't mean that's the best role for you. I think that's what I mean, make sure they are aimed at what they’re best at, to make it a success. Because if I put the person here, very shy, and doesn't want to do sales at the VegFest both, then they're it's a wasted volunteer. If they are going to stand there and not talk to people... that person might be great here to help put a barricade. So yeah just like making sure every person even if I have an unlimited number of you doesn't mean one, they should all be volunteering...**part of organizing volunteers, is to put them in there, where their strengths are, and then you have a very successful event. Another lesson I’ve learned.**”
>
> #### Briar, Q11.2

Each VegFest uses volunteers differently but everyone we volunteered spoke about how volunteerism has played a vital role in their events. Many of the VegFests we examined, and indeed many across North America, are fortunate to have an abundance of volunteers. Making sure that this resource is used to its full potential is one of the factors that contributes to the success of a VegFest. A skilled coordinator will use effective volunteer recruitment strategies, will know how to connect a volunteer with an appropriate task and will ensure that there is a great return on the time and effort they have invested in the volunteers. Please recall that this is not a “return” that is reducible to hours of free labor, but includes gains related to community building, impact, fundraising, and group cohesion on an organizational scale.

>“We get a fantastic volunteer support. We're happy that volunteers stay engaged. A lot of volunteers from last year volunteered with us at events throughout the year. This year they're maybe taking on more leadership responsibilities. That definitely contributes to the success of the event.” >
> #### Franz Q6.3.4

What formally separates a ‘volunteer’ from an ‘unpaid organizer’ or ‘board member’ varied across our case studies. While a great percentage of organizers are not paid for their work, many would hesitate to self-identify as a volunteer. The distinction appears to be found in some combination of veteran status in the group, and the formality of their role and their level of responsibility for preliminary planning.

When we asked “how important are volunteers for your event?”, organized universally reported that they are crucial to the event’s existence. Accordingly, volunteerism was discussed without disparagement, only respect and gratitude. As a group, they are defined by how much of the event’s success is dependent on their labor and versatility. It goes without saying that enlisting dozens of unpaid workers greatly impacts the outcome of a VegFest. Several VegFests function as fundraisers, and unpaid labor increases their bottom line, just as it does for those who only wish to be sustainable and break even. A strong argument could be made that any goal stated by our interview participants is dependent on volunteer labour, whether enabling the event to be free of cost as a way to increase attendance, or by enticing non-vegan or vegetarians to attend by publicizing the event far and wide. In the context of an animal advocacy movement, volunteering is more than simply working for a cause. Volunteering is both altruism and action, meaningful ways that help celebrate the values of the community.  

Organizers and volunteers are equally vital to a VegFest’s success. As mentioned previously, divided tasks and roles can make participation accessible and appealing to a broad range of interested parties. The goal is never to make volunteers graduate into organizers, but to make volunteering independently meaningful in the ways that is apt to do so - by being a gratifying way to participate in a movement, to learn skills, and to connect with like minded others. Meanwhile, organizers who promote a mechanism for volunteers to take on responsibilities and find a role in the core organization if so desired will only benefit from their efforts in the future.

>“I really think that, like, meeting people together and making every meeting partially a potluck or we provide a little bit food, or going out afterwards really creates like a real close volunteer community. We found that to be true, that a lot of our volunteers throughout the year have come from these two VegFests that are some of our real core volunteers at the [organization].”
>
> #### Darcy, Q4.6.1

## Community outreach and participation

The closing quote from *Darcy* in the above section explains the importance of in-person connections when organizing an event. *Shay* expands on this idea, arguing that it is a way to build mutual support within the milieu.

>“If you don't share anybody else's event, and if you don't attend other people's events, if you don't pay to go to people's events, then you've never really supported them in any meaningful way. Then you expect them to go above and beyond to help you, it's just not going to happen. People will help you if they have a long relationship with you, and you've always been an asset to them.”
>
> #### Shay Q3.1

Previously, we considered *Val’s* advice on starting slow and taking part in events that will establish the means to organize a VegFest, in the Skills and Expertise section. *Shay* seconds this notion, with a special emphasis on solidifying community support and resources in advance.

>“I would say do it, but I would say what I said before. The key things are, do you already have relationships in your local community that you believe will realistically will help you? Do you have contact with food vendors? I would say, start having conversations with people, where you get loose commitments, before you decide to do it. Then try to get as many people on board before you start. That's what I would say. I'll also say people to start small. The smartest way to do it is, church community centers or something that's indoors. It's a low entry point to start at and if 100 people show up, 50 people show up and you don't lose any money on it, that's a really good thing. Then, from that first year...or if you're outdoors, that's a high traffic area. I think farmers markets are great. Huge potential will be at a farmers market. They'll all take part at a farmers market.”
>
> #### Shay Q11.1

Part of VegFest organizing is making connections with local animal advocacy groups, food security groups, and other potential allies. This is done with advocacy in mind, a point to be emphasized. Despite how much discourse is spent on logistical goals and vendor/exhibitor commitments, there is always the core goal to reach out to others in the community to popularize veganism, or insert animal issues into every context. The values of a VegFest are the pivot point for all community participation.

Since members of other community groups often don't share the exact same values as VegFest organizing groups, community outreach and participation must approach animal rights as an intersectional issue and also an issue that transcends demographic barriers. In other words, the motivation for organizers to build these ties with other groups is invariably a belief that veganism can and should be appealing to everyone and so education and access to food choices are the main barriers. Organizers often communicated that their commitment to animal rights issues are based on compassion and an aversion to suffering, which they see as core values that also run through other social movements. How vegan groups make these connections can vary depending on their local contexts. For example, community participation could look like hosting a vegan pub crawl with educational trivia games or it could be an a VegFest group offering free vegan catering for a youth drop in center in an urban food desert. Both build community in different ways.

>“for the VegFest... but also for the other events, we partner with other groups so you have been partnered with like black youth initiatives that was getting people to a hip hop event this year...it's just like a thing in an area of [location] called [name] that was almost entirely Latino you'll see like Spanish is the main language. So we partner with a number of organizers, like the [food security organization] or an Indigenous Mexican organization. And so partnering with all those groups that they can then go back to their communities and create more of a coalition”
>
> #### Darcy Q4.3

Finding ways to build community requires some creativity, but more importantly a dedication to finding out how to reach beyond the limits of one’s networks but still form coalitions that are meaningful and not opportunistic. Community scope is limited by perceptions and target audiences (Marsh, 2016; Vegan Profile). VegFests have community networks in a variety of ways. They form community around political ties to animal rights ideas or to specific groups within the animal movement. VegFests find community among people who share their vegetarian and vegan lifestyle. And VegFests form community based on logical needs, for example by using meetup.com groups to recruit new vegetarians to become volunteers. Often organizers envision expanding the movement’s numbers dramatically, but this is complicated if veganism is the bar for partipating in the movement. This can also limit collaboration with certain groups that might share some affinity otherwise. VegFests are vegan events in that there is a shared understanding that the event and the institution are vegan, but VegFests have been able to grow so quickly in part because they do not require that all participants and volunteers are personally vegan--many volunteers for VegFests are vegan, but there are often also volunteers who are vegetarian, part-time vegetarian, and people who are just beginning to get interested in veg eating.

Vegans are more likely to *stay vegan* if they do this as an ethical choice (Asher et al, 2014), this is supported by comments made by *Channey* when describing the informed approach of the [location] VegFest. If ethical treatment of animals is the pivot point for community connections, do we latently favor increasing long term veganism as the ultimate goal for a VegFest? We would argue that the notion of “ethical concerns for animals” can inspire all sorts of projects and personal changes, a broad idea that can create an impact in ways that are not limited to diet changes. Simply put, community outreach and participation should be grounded in affinity but open to new points of connection.

## Advertisement and demographics
